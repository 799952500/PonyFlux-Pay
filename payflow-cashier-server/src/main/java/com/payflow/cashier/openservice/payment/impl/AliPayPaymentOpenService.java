 ...
 */
@Slf4j
@Service("alipayPaymentOpenService")
@RequiredArgsConstructor
public class AliPayPaymentOpenService implements PayChannelPaymentOpenService {
    ...
    public PayResult pay(String orderId,
        ...
        if (!methodEnum.getCode().startsWith("ALIPAY_")) {
            throw new BizException(7103, "支付方式与渠道不匹配: channel=ALIPAY, payMethod=" + payMethod);
        }
