 ...
 */
@Slf4j
@Component("alipay_qrPayStrategy")
@RequiredArgsConstructor
public class AliPayQrStrategy implements PayStrategy {
    ...
    public PayResult pay(String orderId, Long amount, String subject,
        ...
        var resp = aliPayQrHandler.createQrOrder(orderId, amount, subject, notifyUrl, account);

        return PayResult.builder()
                .status("PROCESSING")
                .action("QR_CODE")
                .qrCodeUrl(resp.getQrCode())
    ...
    public RefundResult refund(String tradeNo, Long refundAmount,
        ...
        AliPayRefundResponse resp = aliPayQrHandler.refund(
                tradeNo, refundAmount, reason, account);
    ...
    public NotifyResult parseNotify(HttpServletRequest request) {
        ...
        log.info("收到支付宝扫码回调: flatParams={}", flatParams);
