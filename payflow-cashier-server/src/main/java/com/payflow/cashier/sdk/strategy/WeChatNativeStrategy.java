 ...
 */
@Slf4j
@Component("wechat_nativePayStrategy")
@RequiredArgsConstructor
public class WeChatNativeStrategy implements PayStrategy {
    ...
    public PayMethod getPayMethod() {
        return PayMethod.WECHAT_NATIVE;
    }
    ...
    public PayResult pay(String orderId, Long amount, String subject,
        ...
        WxPayNativeResponse resp = wxPayNativeHandler.createQrCodeOrder(
                orderId, amount, subject, notifyUrl, account);

        return PayResult.builder()
                .status("PROCESSING")
                .action("QR_CODE")
                .qrCodeUrl(resp.getCodeUrl())
                .channelTradeNo(resp.getPrepayId())
                .build();
    }
