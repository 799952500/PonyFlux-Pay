...
import com.payflow.payment.wechat.WxPayAppHandler;
...
public class WeChatAppStrategy implements PayStrategy {
    ...
    private final WxPayAppHandler wxPayAppHandler;
    private final WxPayNotifyHelper wxPayNotifyHelper;

    @Override
    public PayMethod getPayMethod() {
        return PayMethod.WECHAT_APP;
    }
    ...
    public PayResult pay(String orderId, Long amount, String subject,
        ...
        Map<String, String> params = wxPayAppHandler.createAppOrder(
    ...
    public NotifyResult parseNotify(HttpServletRequest request) {
        ...
        log.info("收到微信App支付回调: serial={}, timestamp={}", serial, timestamp);
