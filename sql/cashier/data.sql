...
-- 订单数据
-- ----------------------------
INSERT INTO `cashier_orders` (`order_id`, `merchant_id`, `merchant_order_no`, `amount`, `currency`, `pay_amount`, `subject`, `body`, `attach`, `channel`, `status`, `notify_url`, `merchant_notify_url`, `return_url`, `expire_time`, `pay_time`, `created_at`, `updated_at`, `notify_status`, `notify_retry_count`) VALUES
