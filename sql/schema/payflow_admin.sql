...
CREATE TABLE `admin_payment_methods` (
  ...
  `method_name_zh_cn` VARCHAR(128) NOT NULL,
  `method_name_zh_tw` VARCHAR(128) NOT NULL,
  `method_name_en` VARCHAR(128) NOT NULL,
  ...
  `priority` INT DEFAULT 0,
  `description` VARCHAR(512) DEFAULT NULL,
  `description_zh_cn` VARCHAR(512) NOT NULL DEFAULT '',
  `description_zh_tw` VARCHAR(512) NOT NULL DEFAULT '',
